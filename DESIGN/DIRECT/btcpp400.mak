...
test.exe: main.o16 direct.lib
	$(D16_LINK) $(D16_LINK_OPTS) @&&!
$(D16_OBJS)+main.o16
$*, , direct.lib service.lib $(D16_LIBS), $(D16_DEF)
!

direct.lib : d_direct.o16
	-@del direct.lib
...
$(D32_OBJS)+main.o32
$*, , direct32.lib servic32.lib $(D32_LIBS)
!
...
ntest.exe: main.obn ndirect.lib wtest.rbj
	$(WNT_LINK) $(WNT_LINK_OPTS) @&&!
$(WNT_OBJS)+main.obn
$*, , ndirect nservice $(WNT_LIBS), wtest.def, wtest.rbj
!
...
9test.exe: main.ob9 9direct.lib wtest.rbj
	$(W32_LINK) $(W32_LINK_OPTS) @&&!
$(W32_OBJS)+main.ob9
$*, , 9direct 9service $(W32_LIBS), , wtest.rbj
!
