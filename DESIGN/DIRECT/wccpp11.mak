...
QNX_MODULE_LIB= ../../lib/libZdirect.a
...
mtest.exe: main.obm mdirect.lib
	%create dvx_zil.rsp
	@%append dvx_zil.rsp $(DVX_LINK_OPTS)
	@%append dvx_zil.rsp N mtest
	@%append dvx_zil.rsp F main.obm
	@%append dvx_zil.rsp L mdirect.lib,mservice.lib$(DVX_LIBS)
	$(DVX_LINK) @dvx_zil.rsp
	del dvx_zil.rsp

mdirect.lib : m_direct.obm
	-@del mdirect.lib
	$(DVX_LIBRARIAN) $(DVX_LIB_OPTS) $* +m_direct.obm

	copy direct.hpp ..\..\include
	copy mdirect.lib ..\..\lib\$(VERSION)
	copy p_direct.dat ..\..\bin\p_direct.znc
...
$(QNX_MODULE_LIB): m_direct.o
	rm -f $(QNX_MODULE_LIB)
	$(QNX_LIBRARIAN) $(QNX_LIB_OPTS) $@ $?
	cp direct.hpp ../../include
	cp p_direct.dat ../../bin/p_direct.znc
