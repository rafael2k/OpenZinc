...
MODULE_LIBRARY = $(ZINC_LIB_DIR)/libZfile.a
DESIGN_LIBS = $(MODULE_LIBRARY) -lZservice -lZdirect
Z_LIBS = $(DESIGN_LIBS) -l$(ZINC_LIB_NAME) $(GUI_LIBS) $(LIBS)
Z_LIB_DIRS = -L$(ZINC_LIB_DIR) $(LIB_DIRS)
LIBRARIAN = ar
UNIX_LIB_OPTS = r
INCLUDE_FILES = $(ZINC_INC_DIR)/file.hpp
DAT_FILE = $(ZINC_BIN_DIR)/p_file.znc
