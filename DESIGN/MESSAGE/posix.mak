...
MODULE_LIBRARY = $(ZINC_LIB_DIR)/libZmessage.a
...
LIBRARIAN = ar
UNIX_LIB_OPTS = r
INCLUDE_FILES = $(ZINC_INC_DIR)/message.hpp
DAT_FILE = $(ZINC_BIN_DIR)/p_messag.znc

TARGET = motif
OBJS = main.o
LIB_OBJS = message.o message1.o prefer.o import_msg.o export_msg.o
COLLISIONS = import_msg$(CPP_EXTENSION) export_msg$(CPP_EXTENSION)
...
$(DAT_FILE):p_messag.dat
	cp $? $@
	chmod 666 $@

clean:
	-rm -f $(PROG) *.o $(MODULE_LIBRARY)
	-rm -f *_msg$(CPP_EXTENSION)
...
import_msg$(CPP_EXTENSION): import$(CPP_EXTENSION)
	cp $? $@

export_msg$(CPP_EXTENSION): export$(CPP_EXTENSION)
	cp $? $@
