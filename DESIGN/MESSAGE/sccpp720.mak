...
nmsgedit.exe: main.obn nmessage.lib
	$(WNT_LINK) $(WNT_LINK_OPTS) $(WNT_OBJS)+main.obn, $*, ,nmessage nstorage ndirect nstredit nservice $(WNT_LIBS)


nmessage.lib : message.obn message1.obn prefer.obn import.obn export.obn
	-@del nmessage.lib
	$(WNT_LIBRARIAN) $(WNT_LIB_OPTS) nmessage+message.obn+message1.obn+prefer.obn+import.obn+export.obn;
...
9msgedit.exe: main.ob9 9message.lib
	$(W32_LINK) $(W32_LINK_OPTS) $(W32_OBJS)+main.ob9, $*, ,9message 9storage 9direct 9stredit 9service $(W32_LIBS)


9message.lib : message.ob9 message1.ob9 prefer.ob9 import.ob9 export.ob9
	-@del 9message.lib
	$(W32_LIBRARIAN) $(W32_LIB_OPTS) 9message+message.ob9+message1.ob9+prefer.ob9+import.ob9+export.ob9;
