...
QNX_MODULE_LIB= ../../lib/libZservice.a
QNX_DESIGN_LIBS=
QNX_CPP= CC
QNX_LINK= CC
QNX_LIBRARIAN= wlib
...
QNX_OBJS=
QNX_LIBS= -l$(QNX_LIB_NAME) -l$(QNX_MODULE_LIB) \
...
mtest.exe: main.obm mservice.lib
	%create dvx_zil.rsp
...
mservice.lib : service.obm
	-@del mservice.lib
	$(DVX_LIBRARIAN) $(DVX_LIB_OPTS) $* +service.obm

	copy service.hpp ..\..\include
	copy mservice.lib ..\..\lib\$(VERSION)
	copy p_servic.dat ..\..\bin\p_servic.znc
...
$(QNX_MODULE_LIB): service.o
	rm -f $(QNX_MODULE_LIB)
	$(QNX_LIBRARIAN) $(QNX_LIB_OPTS) $@ $?
	cp service.hpp ../../include
	cp p_servic.dat ../../bin/p_servic.znc
