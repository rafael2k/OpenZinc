...
MODULE_LIBRARY = $(ZINC_LIB_DIR)/libZservice.a
DESIGN_LIBS = $(MODULE_LIBRARY)
Z_LIBS = $(MODULE_LIBRARY) -l$(ZINC_LIB_NAME) $(GUI_LIBS) $(LIBS)
Z_LIB_DIRS = -L$(ZINC_LIB_DIR) $(LIB_DIRS)
LIBRARIAN = ar
UNIX_LIB_OPTS = r
INCLUDE_FILES = $(ZINC_INC_DIR)/service.hpp
DAT_FILE = $(ZINC_BIN_DIR)/p_servic.znc
