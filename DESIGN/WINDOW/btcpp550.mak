...
WIN_CPP_OPTS=-c -d -dc -ml -O1 -x- -RT- -Vf -WE -w $(DBG_CPP) -H=ZIL.SYM
WIN_RC_OPTS=-k
WIN_LINK_OPTS=/c /C /Twe /x $(DBG_LNK)
WIN_LIB_OPTS=/C
...
WNT_CPP_OPTS=-c -O1 -x- -RT- -W $(DBG_CPP) -H=ZIL.sym
WNT_LINK_OPTS=-Tpe -aa -c -x  $(DBG_LNK)
WNT_RC_OPTS=-w32
WNT_LIB_OPTS=/C
...
W32_CPP_OPTS=-c -O1 -x- -RT- -W -DZIL_WIN32 $(DBG_CPP) -H=ZIL.SYM
W32_LINK_OPTS=-Tpe -aa -c -x $(DBG_LNK)
W32_RC_OPTS=-w32
W32_LIB_OPTS=/C
...
wwinedit.exe: main.obw wwindow.lib $(WIN_TST_OBJS)
	$(WIN_LINK) $(WIN_LINK_OPTS) @&&!
$(WIN_OBJS)+main.obw $(WIN_TST_OBJS)
...
nwinedit.exe: main.obn nwindow.lib wwindow.rbj $(WNT_TST_OBJS)
	$(WNT_LINK) $(WNT_LINK_OPTS) @&&!
$(WNT_OBJS)+main.obn $(WNT_TST_OBJS)
...
9winedit.exe: main.ob9 9window.lib $(TARGET_W32_FIX1) $(TARGET_W32_FIX2) wwindow.rbj
	$(W32_LINK) $(W32_LINK_OPTS) @&&!
$(W32_OBJS)+main.ob9 $(TARGET_W32_FIX1) $(TARGET_W32_FIX2)
