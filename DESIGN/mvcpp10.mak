...
#	----- Level 1 Applications -----
	@cd service
	nmake -f mvcpp10.mak servic32.lib
	@cd ..
#	----- Level 2 Applications -----
	@cd storage
	nmake -f mvcpp10.mak storag32.lib
	@cd ..
	@cd direct
	nmake -f mvcpp10.mak direct32.lib
	@cd ..
	@cd stredit
	nmake -f mvcpp10.mak stredi32.lib
	@cd ..
#	----- Level 3 Applications -----
	@cd help
	nmake -f mvcpp10.mak help32.lib
	@cd ..
	@cd message
	nmake -f mvcpp10.mak messag32.lib
	@cd ..
	@cd image
	nmake -f mvcpp10.mak image32.lib
	@cd ..
	@cd i18n
	nmake -f mvcpp10.mak i18n32.lib
	@cd ..
	@cd file
	nmake -f mvcpp10.mak file32.lib
	@cd ..
	@cd window
	nmake -f mvcpp10.mak window32.lib
	@cd ..
