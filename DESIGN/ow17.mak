...
#    wmake -f ow17.mak dos32       (makes the DOS designer)
#    wmake -f ow17.mak windows     (makes the Windows designer)
#    wmake -f ow17.mak winnt       (makes the Windows NT designer)
#    wmake -f ow17.mak os2         (makes the OS/2 designer)
#    wmake -f ow17.mak dvx         (makes the DESQView/X designer)
#    make -f ow17.mak qnx          (makes the QNX designer)
...
usage: .SYMBOLIC
	@echo ...........
	@echo ...........
	@echo To make the Zinc designer for ow17 C++ type:
	@echo wmake -f ow17.mak dos32
	@echo wmake -f ow17.mak windows
	@echo wmake -f ow17.mak winnt
	@echo wmake -f ow17.mak os2
	@echo wmake -f ow17.mak dvx
	@echo make -f ow17.mak qnx
	@echo ...........
	@echo ...........
...
#	----- Level 1 Applications -----
	@cd service
	wmake -f ow17.mak service.lib
	@cd ..
#	----- Level 2 Applications -----
	@cd storage
	wmake -f ow17.mak storage.lib
	@cd ..
	@cd direct
	wmake -f ow17.mak direct.lib
	@cd ..
	@cd stredit
	wmake -f ow17.mak stredit.lib
	@cd ..
#	----- Level 3 Applications -----
	@cd help
	wmake -f ow17.mak help.lib
	@cd ..
	@cd message
	wmake -f ow17.mak message.lib
	@cd ..
	@cd image
	wmake -f ow17.mak image.lib
	@cd ..
	@cd i18n
	wmake -f ow17.mak i18n.lib
	@cd ..
	@cd file
	wmake -f ow17.mak file.lib
	@cd ..
	@cd window
	wmake -f ow17.mak window.lib
	@cd ..
...
#	----- Level 1 Applications -----
	@cd service
	wmake -f ow17.mak wservice.lib
	@cd ..
#	----- Level 2 Applications -----
	@cd storage
	wmake -f ow17.mak wstorage.lib
	@cd ..
	@cd direct
	wmake -f ow17.mak wdirect.lib
	@cd ..
	@cd stredit
	wmake -f ow17.mak wstredit.lib
	@cd ..
#	----- Level 3 Applications -----
	@cd help
	wmake -f ow17.mak whelp.lib
	@cd ..
	@cd message
	wmake -f ow17.mak wmessage.lib
	@cd ..
	@cd image
	wmake -f ow17.mak wimage.lib
	@cd ..
	@cd i18n
	wmake -f ow17.mak wi18n.lib
	@cd ..
	@cd file
	wmake -f ow17.mak wfile.lib
	@cd ..
	@cd window
	wmake -f ow17.mak wwindow.lib
	@cd ..
...
#	----- Level 1 Applications -----
	@cd service
	wmake -f ow17.mak nservice.lib
	@cd ..
#	----- Level 2 Applications -----
	@cd storage
	wmake -f ow17.mak nstorage.lib
	@cd ..
	@cd direct
	wmake -f ow17.mak ndirect.lib
	@cd ..
	@cd stredit
	wmake -f ow17.mak nstredit.lib
	@cd ..
#	----- Level 3 Applications -----
	@cd help
	wmake -f ow17.mak nhelp.lib
	@cd ..
	@cd message
	wmake -f ow17.mak nmessage.lib
	@cd ..
	@cd image
	wmake -f ow17.mak nimage.lib
	@cd ..
	@cd i18n
	wmake -f ow17.mak ni18n.lib
	@cd ..
	@cd file
	wmake -f ow17.mak nfile.lib
	@cd ..
	@cd window
	wmake -f ow17.mak nwindow.lib
	@cd ..
...
#	----- Level 1 Applications -----
	@cd service
	wmake -f ow17.mak 9service.lib
	@cd ..
#	----- Level 2 Applications -----
	@cd storage
	wmake -f ow17.mak 9storage.lib
	@cd ..
	@cd direct
	wmake -f ow17.mak 9direct.lib
	@cd ..
	@cd stredit
	wmake -f ow17.mak 9stredit.lib
	@cd ..
#	----- Level 3 Applications -----
	@cd help
	wmake -f ow17.mak 9help.lib
	@cd ..
	@cd message
	wmake -f ow17.mak 9message.lib
	@cd ..
	@cd image
	wmake -f ow17.mak 9image.lib
	@cd ..
	@cd i18n
	wmake -f ow17.mak 9i18n.lib
	@cd ..
	@cd file
	wmake -f ow17.mak 9file.lib
	@cd ..
	@cd window
	wmake -f ow17.mak 9window.lib
	@cd ..
...
#	----- Level 1 Applications -----
	@cd service
	wmake -f ow17.mak oservice.lib
	@cd ..
#	----- Level 2 Applications -----
	@cd storage
	wmake -f ow17.mak ostorage.lib
	@cd ..
	@cd direct
	wmake -f ow17.mak odirect.lib
	@cd ..
	@cd stredit
	wmake -f ow17.mak ostredit.lib
	@cd ..
#	----- Level 3 Applications -----
	@cd help
	wmake -f ow17.mak ohelp.lib
	@cd ..
	@cd message
	wmake -f ow17.mak omessage.lib
	@cd ..
	@cd image
	wmake -f ow17.mak oimage.lib
	@cd ..
	@cd window
	wmake -f ow17.mak owindow.lib
	@cd ..
	@cd i18n
	wmake -f ow17.mak oi18n.lib
	@cd ..
	@cd file
	wmake -f ow17.mak ofile.lib
	@cd ..
...
#	----- Level 1 Applications -----
	@cd service
	wmake -f ow17.mak mservice.lib
	@cd ..
#	----- Level 2 Applications -----
	@cd storage
	wmake -f ow17.mak mstorage.lib
	@cd ..
	@cd direct
	wmake -f ow17.mak mdirect.lib
	@cd ..
	@cd stredit
	wmake -f ow17.mak mstredit.lib
	@cd ..
#	----- Level 3 Applications -----
	@cd help
	wmake -f ow17.mak mhelp.lib
	@cd ..
	@cd message
	wmake -f ow17.mak mmessage.lib
	@cd ..
	@cd image
	wmake -f ow17.mak mimage.lib
	@cd ..
	@cd window
	wmake -f ow17.mak mwindow.lib
	@cd ..
	@cd i18n
	wmake -f ow17.mak mi18n.lib
	@cd ..
	@cd file
	wmake -f ow17.mak mfile.lib
	@cd ..
...
make_qnx_modules:
#	----- Level 1 Applications -----
	(cd service;make -f ow17.mak qnx_module)
#	----- Level 2 Applications -----
	(cd storage;make -f ow17.mak qnx_module)
	(cd direct;make -f ow17.mak qnx_module)
	(cd stredit;make -f ow17.mak qnx_module)
#	----- Level 3 Applications -----
	(cd help;make -f ow17.mak qnx_module)
	(cd message;make -f ow17.mak qnx_module)
	(cd image;make -f ow17.mak qnx_module)
	(cd window;make -f ow17.mak qnx_module)
	(cd i18n;make -f ow17.mak qnx_module)
	(cd file;make -f ow17.mak qnx_module)

qclean:
	rm -f design *.o
#	----- Level 1 Applications -----
	(cd service;make -f ow17.mak qclean)
#	----- Level 2 Applications -----
	(cd storage;make -f ow17.mak qclean)
	(cd direct;make -f ow17.mak qclean)
	(cd stredit;make -f ow17.mak qclean)
#	----- Level 3 Applications -----
	(cd help;make -f ow17.mak qclean)
	(cd message;make -f ow17.mak qclean)
	(cd image;make -f ow17.mak qclean)
	(cd window;make -f ow17.mak qclean)
	(cd i18n;make -f ow17.mak qclean)
	(cd file;make -f ow17.mak qclean)
