...
#    wmake -f wccpp11.mak dos32       (makes the DOS designer)
#    wmake -f wccpp11.mak windows     (makes the Windows designer)
#    wmake -f wccpp11.mak winnt       (makes the Windows NT designer)
#    wmake -f wccpp11.mak os2         (makes the OS/2 designer)
#    wmake -f wccpp11.mak dvx         (makes the DESQView/X designer)
#    make -f wccpp11.mak qnx          (makes the QNX designer)
...
usage: .SYMBOLIC
	...
	@echo wmake -f wccpp11.mak dos32
	@echo wmake -f wccpp11.mak windows
	@echo wmake -f wccpp11.mak winnt
	@echo wmake -f wccpp11.mak os2
	@echo wmake -f wccpp11.mak dvx
	@echo make -f wccpp11.mak qnx
	@echo ...........
	@echo ...........
...
#	----- Level 1 Applications -----
	@cd service
	wmake -f wccpp11.mak service.lib
	@cd ..
#	----- Level 2 Applications -----
	@cd storage
	wmake -f wccpp11.mak storage.lib
	@cd ..
	@cd direct
	wmake -f wccpp11.mak direct.lib
	@cd ..
	@cd stredit
	wmake -f wccpp11.mak stredit.lib
	@cd ..
#	----- Level 3 Applications -----
	@cd help
	wmake -f wccpp11.mak help.lib
	@cd ..
	@cd message
	wmake -f wccpp11.mak message.lib
	@cd ..
	@cd image
	wmake -f wccpp11.mak image.lib
	@cd ..
	@cd i18n
	wmake -f wccpp11.mak i18n.lib
	@cd ..
	@cd file
	wmake -f wccpp11.mak file.lib
	@cd ..
	@cd window
	wmake -f wccpp11.mak window.lib
	@cd ..
...
#	----- Level 1 Applications -----
	@cd service
	wmake -f wccpp11.mak wservice.lib
	@cd ..
#	----- Level 2 Applications -----
	@cd storage
	wmake -f wccpp11.mak wstorage.lib
	@cd ..
	@cd direct
	wmake -f wccpp11.mak wdirect.lib
	@cd ..
	@cd stredit
	wmake -f wccpp11.mak wstredit.lib
	@cd ..
#	----- Level 3 Applications -----
	@cd help
	wmake -f wccpp11.mak whelp.lib
	@cd ..
	@cd message
	wmake -f wccpp11.mak wmessage.lib
	@cd ..
	@cd image
	wmake -f wccpp11.mak wimage.lib
	@cd ..
	@cd i18n
	wmake -f wccpp11.mak wi18n.lib
	@cd ..
	@cd file
	wmake -f wccpp11.mak wfile.lib
	@cd ..
	@cd window
	wmake -f wccpp11.mak wwindow.lib
	@cd ..
...
#	----- Level 1 Applications -----
	@cd service
	wmake -f wccpp11.mak nservice.lib
	@cd ..
#	----- Level 2 Applications -----
	@cd storage
	wmake -f wccpp11.mak nstorage.lib
	@cd ..
	@cd direct
	wmake -f wccpp11.mak ndirect.lib
	@cd ..
	@cd stredit
	wmake -f wccpp11.mak nstredit.lib
	@cd ..
#	----- Level 3 Applications -----
	@cd help
	wmake -f wccpp11.mak nhelp.lib
	@cd ..
	@cd message
	wmake -f wccpp11.mak nmessage.lib
	@cd ..
	@cd image
	wmake -f wccpp11.mak nimage.lib
	@cd ..
	@cd i18n
	wmake -f wccpp11.mak ni18n.lib
	@cd ..
	@cd file
	wmake -f wccpp11.mak nfile.lib
	@cd ..
	@cd window
	wmake -f wccpp11.mak nwindow.lib
	@cd ..
...
#	----- Level 1 Applications -----
	@cd service
	wmake -f wccpp11.mak 9service.lib
	@cd ..
#	----- Level 2 Applications -----
	@cd storage
	wmake -f wccpp11.mak 9storage.lib
	@cd ..
	@cd direct
	wmake -f wccpp11.mak 9direct.lib
	@cd ..
	@cd stredit
	wmake -f wccpp11.mak 9stredit.lib
	@cd ..
#	----- Level 3 Applications -----
	@cd help
	wmake -f wccpp11.mak 9help.lib
	@cd ..
	@cd message
	wmake -f wccpp11.mak 9message.lib
	@cd ..
	@cd image
	wmake -f wccpp11.mak 9image.lib
	@cd ..
	@cd i18n
	wmake -f wccpp11.mak 9i18n.lib
	@cd ..
	@cd file
	wmake -f wccpp11.mak 9file.lib
	@cd ..
	@cd window
	wmake -f wccpp11.mak 9window.lib
	@cd ..
...
#	----- Level 1 Applications -----
	@cd service
	wmake -f wccpp11.mak oservice.lib
	@cd ..
#	----- Level 2 Applications -----
	@cd storage
	wmake -f wccpp11.mak ostorage.lib
	@cd ..
	@cd direct
	wmake -f wccpp11.mak odirect.lib
	@cd ..
	@cd stredit
	wmake -f wccpp11.mak ostredit.lib
	@cd ..
#	----- Level 3 Applications -----
	@cd help
	wmake -f wccpp11.mak ohelp.lib
	@cd ..
	@cd message
	wmake -f wccpp11.mak omessage.lib
	@cd ..
	@cd image
	wmake -f wccpp11.mak oimage.lib
	@cd ..
	@cd window
	wmake -f wccpp11.mak owindow.lib
	@cd ..
	@cd i18n
	wmake -f wccpp11.mak oi18n.lib
	@cd ..
	@cd file
	wmake -f wccpp11.mak ofile.lib
	@cd ..
...
#	----- Level 1 Applications -----
	@cd service
	wmake -f wccpp11.mak mservice.lib
	@cd ..
#	----- Level 2 Applications -----
	@cd storage
	wmake -f wccpp11.mak mstorage.lib
	@cd ..
	@cd direct
	wmake -f wccpp11.mak mdirect.lib
	@cd ..
	@cd stredit
	wmake -f wccpp11.mak mstredit.lib
	@cd ..
#	----- Level 3 Applications -----
	@cd help
	wmake -f wccpp11.mak mhelp.lib
	@cd ..
	@cd message
	wmake -f wccpp11.mak mmessage.lib
	@cd ..
	@cd image
	wmake -f wccpp11.mak mimage.lib
	@cd ..
	@cd window
	wmake -f wccpp11.mak mwindow.lib
	@cd ..
	@cd i18n
	wmake -f wccpp11.mak mi18n.lib
	@cd ..
	@cd file
	wmake -f wccpp11.mak mfile.lib
	@cd ..
...
make_qnx_modules:
#	----- Level 1 Applications -----
	(cd service;make -f wccpp11.mak qnx_module)
#	----- Level 2 Applications -----
	(cd storage;make -f wccpp11.mak qnx_module)
	(cd direct;make -f wccpp11.mak qnx_module)
	(cd stredit;make -f wccpp11.mak qnx_module)
#	----- Level 3 Applications -----
	(cd help;make -f wccpp11.mak qnx_module)
	(cd message;make -f wccpp11.mak qnx_module)
	(cd image;make -f wccpp11.mak qnx_module)
	(cd window;make -f wccpp11.mak qnx_module)
	(cd i18n;make -f wccpp11.mak qnx_module)
	(cd file;make -f wccpp11.mak qnx_module)

qclean:
	rm -f design *.o
#	----- Level 1 Applications -----
	(cd service;make -f wccpp11.mak qclean)
#	----- Level 2 Applications -----
	(cd storage;make -f wccpp11.mak qclean)
	(cd direct;make -f wccpp11.mak qclean)
	(cd stredit;make -f wccpp11.mak qclean)
#	----- Level 3 Applications -----
	(cd help;make -f wccpp11.mak qclean)
	(cd message;make -f wccpp11.mak qclean)
	(cd image;make -f wccpp11.mak qclean)
	(cd window;make -f wccpp11.mak qclean)
	(cd i18n;make -f wccpp11.mak qclean)
	(cd file;make -f wccpp11.mak qclean)
