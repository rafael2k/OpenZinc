...
#------ Digital Mars no longer supports VCM overlays !!!!!!!!!!!!!!!!!!  ----
OVL_CPP=dmc
OVL_LINK=link
OVL_LIBRARIAN=lib
...
WIN_CPP_OPTS=-c -a1 -ml -W2 -o+space -R
WIN_RC_OPTS=-k
...
usage:
	...
	@echo make -fdm.mak dosovl  # VCM overlays no longer supported!
...
dos: copy gfx_copy OEMfont ISOfont dos_gfx.lib dm_lgfx.lib test.exe
...
dosovl: copy gfx_copy dos_gfxv.lib dm_lgfxv.lib dos_zilv.lib  testovl.exe
...
dm_lgfxv.lib :
	@cd gfx\source
	make -f dm.mak dosovl
	@cd ..\..

# ----- DOS 32 bit extender (X-32VM) compiler options -----------------------
dos32: copy gfx_copy d32_gfx.lib dm_32gfx.lib test32.exe
