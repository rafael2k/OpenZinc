...
#    wmake -f ow14.mak dos32       (makes the DOS display tutorial)
#    wmake -f ow14.mak windows     (makes the Windows display tutorial)
#    wmake -f ow14.mak winnt       (makes the Windows NT display tutorial)
#    wmake -f ow14.mak os2         (makes the OS/2 display tutorial)
#    wmake -f ow14.mak dvx         (makes the DESQView/X display tutorial)
#    make -f ow14.mak qnx          (makes the QNX display tutorial)
