...
#	make -fsccpp720.mak  dos		(makes the DOS display program)
#	make -fsccpp720.mak  dosovl		(makes the DOS VCM overlay display program)
#	make -fsccpp720.mak  dos32		(makes the DOS extender display program)
...
DOS_CPP=sc
DOS_LINK=link
DOS_CPP_OPTS=-c -a1 -bx -ml -o+space -R -DGFX_DISPLAY
...
D32_CPP=sc
D32_LINK=link
D32_CPP_OPTS=-c -bx -mx -o+space -R -DGFX_DISPLAY
D32_LINK_OPTS=/NOI
D32_LIB_OPTS=/C /N /B
...
usage:
	...
	@echo sake -fsccpp720.mak  dosovl
	@echo sake -fsccpp720.mak  dos32
