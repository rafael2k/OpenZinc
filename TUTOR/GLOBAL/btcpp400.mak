...
#    make -fbtcpp400.mak dos             (makes all the DOS intrpol tutorials)
#    make -fbtcpp400.mak dosovl          (makes the DOS overlay intrpol tutorials)
#    make -fbtcpp400.mak dos16           (makes all the DOS extender intrpol tutorials)
#    make -fbtcpp400.mak dos32           (makes all the DOS extender intrpol tutorials)
#    make -fbtcpp400.mak windows         (makes all the Windows intrpol tutorials)
#    make -f btcpp400.mak winnt          (makes all the Windows NT intrpol tutorials)
