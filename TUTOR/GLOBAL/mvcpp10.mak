...
#    nmake -f mvcpp10.mak dos32       (makes all the DOS TNT extender intrpol tutorials)
#    nmake -f mvcpp10.mak winnt       (makes all the Windows intrpol tutorials)
#    nmake -f mvcpp10.mak win32       (makes all the 32 bit Windows intrpol tutorials)
