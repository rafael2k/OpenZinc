...
#    wmake -f ow15.mak dos32       (makes the DOS intrpol tutorial)
#    wmake -f ow15.mak windows     (makes the Windows intrpol tutorial)
#    wmake -f ow15.mak winnt       (makes the Windows NT intrpol tutorial)
#    wmake -f ow15.mak win32       (makes the Windows 95 intrpol tutorial)
#    wmake -f ow15.mak os2         (makes the OS/2 intrpol tutorial)
#    wmake -f ow15.mak dvx         (makes the DESQView/X intrpol tutorial)
#    make -f ow15.mak qnx          (makes the QNX intrpol tutorial)
