...
#    wmake -f ow17.mak dos32       (makes the DOS intrpol tutorial)
#    wmake -f ow17.mak windows     (makes the Windows intrpol tutorial)
#    wmake -f ow17.mak winnt       (makes the Windows NT intrpol tutorial)
#    wmake -f ow17.mak win32       (makes the Windows 95 intrpol tutorial)
#    wmake -f ow17.mak os2         (makes the OS/2 intrpol tutorial)
#    wmake -f ow17.mak dvx         (makes the DESQView/X intrpol tutorial)
#    make -f ow17.mak qnx          (makes the QNX intrpol tutorial)
