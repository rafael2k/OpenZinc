...
#    wmake -f ow19.mak dos32       (makes the DOS intrpol tutorial)
#    wmake -f ow19.mak windows     (makes the Windows intrpol tutorial)
#    wmake -f ow19.mak winnt       (makes the Windows NT intrpol tutorial)
#    wmake -f ow19.mak win32       (makes the Windows 95 intrpol tutorial)
#    wmake -f ow19.mak os2         (makes the OS/2 intrpol tutorial)
#    wmake -f ow19.mak dvx         (makes the DESQView/X intrpol tutorial)
#    make -f ow19.mak qnx          (makes the QNX intrpol tutorial)
