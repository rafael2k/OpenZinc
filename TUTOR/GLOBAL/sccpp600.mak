...
#    make -fsccpp600.mak dos  	      	(makes all the DOS intrpol tutorials)
#    make -fsccpp600.mak dosovl      	(makes all the DOS VCM overlay intrpol tutorials)
#    make -fsccpp600.mak dos32	      	(makes all the DOS extender intrpol tutorials)
#    make -fsccpp600.mak windows      	(makes all the Windows intrpol tutorials)
