...
#    wmake -f ow15.mak dos32       (makes the DOS hello tutorial)
#    wmake -f ow15.mak windows     (makes the Windows hello tutorial)
#    wmake -f ow15.mak winnt       (makes the Windows NT hello tutorial)
#    wmake -f ow15.mak win32       (makes the Windows NT hello tutorial)
#    wmake -f ow15.mak os2         (makes the OS/2 hello tutorial)
#    wmake -f ow15.mak dvx         (makes the DESQView/X hello tutorial)
#    make -f ow15.mak qnx          (makes the QNX hello tutorial)
