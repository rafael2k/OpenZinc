...
#    wmake -f ow16.mak dos32       (makes the DOS hello tutorial)
#    wmake -f ow16.mak windows     (makes the Windows hello tutorial)
#    wmake -f ow16.mak winnt       (makes the Windows NT hello tutorial)
#    wmake -f ow16.mak win32       (makes the Windows NT hello tutorial)
#    wmake -f ow16.mak os2         (makes the OS/2 hello tutorial)
#    wmake -f ow16.mak dvx         (makes the DESQView/X hello tutorial)
#    make -f ow16.mak qnx          (makes the QNX hello tutorial)
