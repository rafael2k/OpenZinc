...
#    wmake -f wccpp.mak dos32       (makes the DOS hello tutorial)
#    wmake -f wccpp.mak windows     (makes the Windows hello tutorial)
#    wmake -f wccpp.mak winnt       (makes the Windows NT hello tutorial)
#    wmake -f wccpp.mak win32       (makes the Windows NT hello tutorial)
#    wmake -f wccpp.mak os2         (makes the OS/2 hello tutorial)
#    wmake -f wccpp.mak dvx         (makes the DESQView/X hello tutorial)
#    make -f wccpp.mak qnx          (makes the QNX hello tutorial)
