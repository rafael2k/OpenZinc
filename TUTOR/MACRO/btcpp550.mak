...
#    make -fbtcpp550.mak dos           (makes the DOS macro program)
#    make -fbtcpp550.mak dosovl        (makes the DOS overlay macro program)
#    make -fbtcpp550.mak dos16         (makes the DOS extender macro program)
#    make -fbtcpp550.mak dos32         (makes the DOS extender macro program)
#    make -fbtcpp550.mak windows       (makes the Windows macro program)
#    make -f btcpp550.mak winnt         (makes the Windows macro program)
