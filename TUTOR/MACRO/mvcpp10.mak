...
#    nmake -f mvcpp10.mak dos32       (makes the DOS TNT extender macro tutorial)
#    nmake -f mvcpp10.mak winnt       (makes the Windows NT macro tutorial)
#    nmake -f mvcpp10.mak win32       (makes the Windows NT macro tutorial)
