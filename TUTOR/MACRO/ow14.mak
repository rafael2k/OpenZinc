...
#    wmake -f ow14.mak dos32       (makes the DOS macro tutorial)
#    wmake -f ow14.mak windows     (makes the Windows macro tutorial)
#    wmake -f ow14.mak winnt       (makes the Windows NT macro tutorial)
#    wmake -f ow14.mak win32       (makes the Windows NT macro tutorial)
#    wmake -f ow14.mak os2         (makes the OS/2 macro tutorial)
#    wmake -f ow14.mak dvx         (makes the DESQView/X macro tutorial)
#    make -f ow14.mak qnx          (makes the QNX macro tutorial)
...
usage: .SYMBOLIC
	@echo ...........
	@echo ...........
	@echo To make this Zinc example for ow14 C++ type:
