...
#    wmake -f ow18.mak dos32       (makes the DOS macro tutorial)
#    wmake -f ow18.mak windows     (makes the Windows macro tutorial)
#    wmake -f ow18.mak winnt       (makes the Windows NT macro tutorial)
#    wmake -f ow18.mak win32       (makes the Windows NT macro tutorial)
#    wmake -f ow18.mak os2         (makes the OS/2 macro tutorial)
#    wmake -f ow18.mak dvx         (makes the DESQView/X macro tutorial)
#    make -f ow18.mak qnx          (makes the QNX macro tutorial)
