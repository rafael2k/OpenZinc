...
#    wmake -f ow19.mak dos32       (makes the DOS macro tutorial)
#    wmake -f ow19.mak windows     (makes the Windows macro tutorial)
#    wmake -f ow19.mak winnt       (makes the Windows NT macro tutorial)
#    wmake -f ow19.mak win32       (makes the Windows NT macro tutorial)
#    wmake -f ow19.mak os2         (makes the OS/2 macro tutorial)
#    wmake -f ow19.mak dvx         (makes the DESQView/X macro tutorial)
#    make -f ow19.mak qnx          (makes the QNX macro tutorial)

# Be sure to set the LIB and INCLUDE environment variables for Zinc, e.g.:
# DOS:
#    set INCLUDE=.;C:\WATCOM\H;C:\ZINC\INCLUDE
#    set LIB=.;C:\WATCOM\LIB386\DOS;C:\WATCOM\LIB386;C:\ZINC\LIB\ow19
# WINDOWS:
#    set INCLUDE=.;C:\WATCOM\H;C:\WATCOM\H\WIN;C:\ZINC\INCLUDE
#    set LIB=.;C:\WATCOM\LIB286\WIN;C:\WATCOM\LIB286;C:\ZINC\LIB\ow19
# WIN NT:
#    set INCLUDE=.;C:\WATCOM\H;C:\WATCOM\H\NT;C:\ZINC\INCLUDE
#    set LIB=.;C:\WATCOM\LIB386\NT;C:\WATCOM\LIB386;C:\ZINC\LIB\ow19
# OS/2:
#    set INCLUDE=.;C:\WATCOM\H;C:\WATCOM\H\OS2;C:\ZINC\INCLUDE
#    set LIB=.;C:\WATCOM\LIB386\OS2;C:\WATCOM\LIB386;C:\ZINC\LIB\ow19
# DESQView/X:
#    set INCLUDE=.;C:\DVX\INCLUDE;C:\WATCOM\H;C:\ZINC\INCLUDE
#    set LIB=.;C:\DVX\LIB\C386;C:\WATCOM\LIB386\DOS;C:\WATCOM\LIB386;C:\ZINC\LIB\ow19
...
usage: .SYMBOLIC
	...
	@echo wmake -f ow19.mak dvx
	@echo make -f ow19.mak qnx
	@echo ...........
	@echo ...........
...
# ----- DESQview/X Motif ----------------------------------------------------
dvx: mmacro.exe .SYMBOLIC

mmacro.exe: macro.obm
	$(DVX_LINK) $(DVX_LINK_OPTS) N mmacro.exe F macro.obm $(DVX_OBJS) L $(DVX_LIBS)

# ----- QNX Motif -----------------------------------------------------------
qnx: macro

macro: macro.o
	$(QNX_LINK) $(QNX_LINK_OPTS) -o $@ macro.o $(QNX_LIB_DIRS) $(QNX_LIBS)
