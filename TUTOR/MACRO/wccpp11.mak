...
#    wmake -f wccpp.mak dos32       (makes the DOS macro tutorial)
#    wmake -f wccpp.mak windows     (makes the Windows macro tutorial)
#    wmake -f wccpp.mak winnt       (makes the Windows NT macro tutorial)
#    wmake -f wccpp.mak win32       (makes the Windows NT macro tutorial)
#    wmake -f wccpp.mak os2         (makes the OS/2 macro tutorial)
#    wmake -f wccpp.mak dvx         (makes the DESQView/X macro tutorial)
#    make -f wccpp.mak qnx          (makes the QNX macro tutorial)
