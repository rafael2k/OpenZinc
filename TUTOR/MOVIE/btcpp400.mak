...
#    make -fbtcpp400.mak dos             (makes all the DOS movie tutorials)
#    make -fbtcpp400.mak dosovl          (makes the DOS overlay movie tutorials)
#    make -fbtcpp400.mak dos16           (makes all the DOS extender movie tutorials)
#    make -fbtcpp400.mak dos32           (makes all the DOS extender movie tutorials)
#    make -fbtcpp400.mak windows         (makes all the Windows movie tutorials)
#    make -f btcpp400.mak winnt          (makes all the Windows NT movie tutorials)
