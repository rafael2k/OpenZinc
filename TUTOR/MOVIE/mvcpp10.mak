...
#    nmake -f mvcpp10.mak dos32       (makes all the DOS TNT extender movie tutorials)
#    nmake -f mvcpp10.mak winnt       (makes all the Windows movie tutorials)
#    nmake -f mvcpp10.mak win32       (makes all the Windows movie tutorials)
