...
#    wmake -f ow16.mak dos32       (makes the DOS movie tutorial)
#    wmake -f ow16.mak windows     (makes the Windows movie tutorial)
#    wmake -f ow16.mak winnt       (makes the Windows NT movie tutorial)
#    wmake -f ow16.mak win32       (makes the Windows NT movie tutorial)
#    wmake -f ow16.mak os2         (makes the OS/2 movie tutorial)
#    wmake -f ow16.mak dvx         (makes the DESQView/X movie tutorial)
#    make -f ow16.mak qnx          (makes the QNX movie tutorial)
