...
#    wmake -f ow18.mak dos32       (makes the DOS movie tutorial)
#    wmake -f ow18.mak windows     (makes the Windows movie tutorial)
#    wmake -f ow18.mak winnt       (makes the Windows NT movie tutorial)
#    wmake -f ow18.mak win32       (makes the Windows NT movie tutorial)
#    wmake -f ow18.mak os2         (makes the OS/2 movie tutorial)
#    wmake -f ow18.mak dvx         (makes the DESQView/X movie tutorial)
#    make -f ow18.mak qnx          (makes the QNX movie tutorial)
