...
#    make -fbtcpp400.mak dos             (makes all the DOS vlist tutorials)
#    make -fbtcpp400.mak dosovl          (makes the DOS overlay vlist tutorials)
#    make -fbtcpp400.mak dos16           (makes all the DOS extender vlist tutorials)
#    make -fbtcpp400.mak dos32           (makes all the DOS extender vlist tutorials)
#    make -fbtcpp400.mak windows         (makes all the Windows vlist tutorials)
#    make -f btcpp400.mak winnt          (makes all the Windows NT vlist tutorials)
