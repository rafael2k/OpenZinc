...
#    nmake -f mvcpp10.mak dos32       (makes all the DOS TNT extender vlist tutorials)
#    nmake -f mvcpp10.mak winnt       (makes all the Windows vlist tutorials)
#    nmake -f mvcpp10.mak win32       (makes all the Windows vlist tutorials)

# Be sure to set the LIB and INCLUDE environment variables for Zinc, e.g.:
#    set INCLUDE=.;C:\ZINC\INCLUDE;C:\MSVC\INCLUDE
#    set LIB=.;C:\ZINC\LIB\mvcpp10;C:\MSVC\LIB
...
usage:
	...
	@echo nmake -f mvcpp10.mak dos32
	@echo nmake -f mvcpp10.mak winnt
	@echo nmake -f mvcpp10.mak win32
	@echo ...........
	@echo ...........
