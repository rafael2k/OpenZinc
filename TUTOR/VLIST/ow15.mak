...
#    wmake -f ow15.mak dos32       (makes the DOS vlist tutorial)
#    wmake -f ow15.mak windows     (makes the Windows vlist tutorial)
#    wmake -f ow15.mak winnt       (makes the Windows NT vlist tutorial)
#    wmake -f ow15.mak win32       (makes the Windows NT vlist tutorial)
#    wmake -f ow15.mak os2         (makes the OS/2 vlist tutorial)
#    wmake -f ow15.mak dvx         (makes the DESQView/X vlist tutorial)
#    make -f ow15.mak qnx          (makes the QNX vlist tutorial)
