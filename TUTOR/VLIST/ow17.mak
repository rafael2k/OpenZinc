...
#    wmake -f ow17.mak dos32       (makes the DOS vlist tutorial)
#    wmake -f ow17.mak windows     (makes the Windows vlist tutorial)
#    wmake -f ow17.mak winnt       (makes the Windows NT vlist tutorial)
#    wmake -f ow17.mak win32       (makes the Windows NT vlist tutorial)
#    wmake -f ow17.mak os2         (makes the OS/2 vlist tutorial)
#    wmake -f ow17.mak dvx         (makes the DESQView/X vlist tutorial)
#    make -f ow17.mak qnx          (makes the QNX vlist tutorial)
