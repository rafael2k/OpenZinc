...
#    make -fsccpp600.mak dos  	      	(makes all the DOS vlist tutorials)
#    make -fsccpp600.mak dosovl      	(makes all the DOS VCM overlay vlist tutorials)
#    make -fsccpp600.mak dos32	      	(makes all the DOS extender vlist tutorials)
#    make -fsccpp600.mak windows      	(makes all the Windows vlist tutorials)
