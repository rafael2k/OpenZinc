...
#    wmake -f wccpp.mak dos32       (makes the DOS vlist tutorial)
#    wmake -f wccpp.mak windows     (makes the Windows vlist tutorial)
#    wmake -f wccpp.mak winnt       (makes the Windows NT vlist tutorial)
#    wmake -f wccpp.mak win32       (makes the Windows NT vlist tutorial)
#    wmake -f wccpp.mak os2         (makes the OS/2 vlist tutorial)
#    wmake -f wccpp.mak dvx         (makes the DESQView/X vlist tutorial)
#    make -f wccpp.mak qnx          (makes the QNX vlist tutorial)
