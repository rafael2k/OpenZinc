...
#    make -fbtcpp400.mak dos             (makes all the DOS word tutorials)
#    make -fbtcpp400.mak dosovl          (makes the DOS overlay word tutorials)
#    make -fbtcpp400.mak dos16           (makes all the DOS extender word tutorials)
#    make -fbtcpp400.mak dos32           (makes all the DOS extender word tutorials)
#    make -fbtcpp400.mak windows         (makes all the Windows word tutorials)
#    make -f btcpp400.mak winnt          (makes all the Windows NT word tutorials)
