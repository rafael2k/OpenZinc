...
#    wmake -f ow16.mak dos32       (makes the DOS word tutorial)
#    wmake -f ow16.mak windows     (makes the Windows word tutorial)
#    wmake -f ow16.mak winnt       (makes the Windows NT word tutorial)
#    wmake -f ow16.mak win32       (makes the Windows NT word tutorial)
#    wmake -f ow16.mak os2         (makes the OS/2 word tutorial)
#    wmake -f ow16.mak dvx         (makes the DESQView/X word tutorial)
#    make -f ow16.mak dvx          (makes the QNX word tutorial)
