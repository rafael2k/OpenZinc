...
#    wmake -f ow17.mak dos32       (makes the DOS word tutorial)
#    wmake -f ow17.mak windows     (makes the Windows word tutorial)
#    wmake -f ow17.mak winnt       (makes the Windows NT word tutorial)
#    wmake -f ow17.mak win32       (makes the Windows NT word tutorial)
#    wmake -f ow17.mak os2         (makes the OS/2 word tutorial)
#    wmake -f ow17.mak dvx         (makes the DESQView/X word tutorial)
#    make -f ow17.mak dvx          (makes the QNX word tutorial)
