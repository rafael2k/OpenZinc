...
#    wmake -f wccpp.mak dos32       (makes the DOS word tutorial)
#    wmake -f wccpp.mak windows     (makes the Windows word tutorial)
#    wmake -f wccpp.mak winnt       (makes the Windows NT word tutorial)
#    wmake -f wccpp.mak win32       (makes the Windows NT word tutorial)
#    wmake -f wccpp.mak os2         (makes the OS/2 word tutorial)
#    wmake -f wccpp.mak dvx         (makes the DESQView/X word tutorial)
#    make -f wccpp.mak dvx          (makes the QNX word tutorial)
