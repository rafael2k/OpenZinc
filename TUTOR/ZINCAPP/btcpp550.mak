...
#    make -fbtcpp550.mak dos           (makes the DOS zincapp program)
#    make -fbtcpp550.mak dosovl        (makes the DOS overlay zincapp program)
#    make -fbtcpp550.mak dos16         (makes the DOS extender zincapp program)
#    make -fbtcpp550.mak dos32         (makes the DOS extender zincapp program)
#    make -fbtcpp550.mak windows       (makes the Windows zincapp program)
#    make -f btcpp550.mak winnt        (makes the Windows NT zincapp program)
...
$(D32_OBJS)+zincapp.o32+control.o32+display.o32+window.o32+event.o32+help.o32+support.o32
$*, ,$(D32_LIBS)
!
...
!
	$(RC) $(WIN_RC_OPTS) wzincapp.rc $<

# ----- Windows NT ----------------------------------------------------------
winnt: nzincapp.exe

nzincapp.exe: zincapp.obn control.obn display.obn window.obn event.obn help.obn support.obn wzincapp.rbj
	$(WNT_LINK) $(WNT_LINK_OPTS) @&&!
$(WNT_OBJS)+zincapp.obn+control.obn+display.obn+window.obn+event.obn+help.obn+support.obn
$*, ,$(WNT_LIBS),wzincapp.def,wzincapp.rbj
!

# ----- 32 bit Windows ------------------------------------------------------
win32: 9zincapp.exe

9zincapp.exe: zincapp.ob9 control.ob9 display.ob9 window.ob9 event.ob9 help.ob9 support.ob9 wzincapp.rbj
	$(W32_LINK) $(W32_LINK_OPTS) @&&!
$(W32_OBJS)+zincapp.ob9+control.ob9+display.ob9+window.ob9+event.ob9+help.ob9+support.ob9
$*, ,$(W32_LIBS),wzincapp.def,wzincapp.rbj
!
