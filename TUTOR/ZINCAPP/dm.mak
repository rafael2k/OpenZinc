...
wzincapp.exe: zincapp.obw control.obw display.obw window.obw event.obw help.obw support.obw
	...
	@del win_zil.rsp
	$(WIN_RC) $(WIN_RC_OPTS) wzincapp.rc 

# ----- Winnt ------------------------------------------------
winnt: nzincapp.exe

nzincapp.exe: zincapp.obn control.obn display.obn window.obn event.obn help.obn support.obn
	@echo $(WNT_OBJS)+zincapp.obn+control.obn+display.obn+window.obn+event.obn+help.obn+support.obn>wnt_zil.rsp
	@echo $*,NUL,$(WNT_LIBS)>>wnt_zil.rsp
	$(WNT_LINK) $(WNT_LINK_OPTS) @wnt_zil.rsp
	@del wnt_zil.rsp
...
9zincapp.exe: zincapp.ob9 control.ob9 display.ob9 window.ob9 event.ob9 help.ob9 support.ob9
	@echo $(W32_OBJS)+zincapp.ob9+control.ob9+display.ob9+window.ob9+event.ob9+help.ob9+support.ob9>w32_zil.rsp
	@echo $*,NUL,$(W32_LIBS)>>w32_zil.rsp
	$(W32_LINK) $(W32_LINK_OPTS) @w32_zil.rsp
	@del w32_zil.rsp
