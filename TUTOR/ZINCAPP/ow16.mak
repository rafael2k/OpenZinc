...
#    wmake -f ow16.mak dos32       (makes the DOS zincapp tutorial)
#    wmake -f ow16.mak windows     (makes the Windows zincapp tutorial)
#    wmake -f ow16.mak winnt       (makes the Windows NT zincapp tutorial)
#    wmake -f ow16.mak win32       (makes the Windows NT zincapp tutorial)
#    wmake -f ow16.mak os2         (makes the OS/2 zincapp tutorial)
#    wmake -f ow16.mak dvx         (makes the DESQView/X zincapp tutorial)
#    make -f ow16.mak qnx          (makes the QNX zincapp tutorial)
